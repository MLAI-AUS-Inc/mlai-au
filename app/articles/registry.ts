...
export const ARTICLE_REGISTRY: Record<string, ArticleWithSlug> = {
    ...
    'featured/weekly-deep-dive-into-ai-and-ml-advancements-updates-issue-2': {
        title: 'AI Bits for Techies | Issue #2 | 15 Jan 2026',
        date: '2026-01-15',
        description: 'Are you a rationalist or idealist?',
        author: 'MLAI Editorial Team',
        authors: ['samDonegan', 'junKaiChang', 'juliaPonder', 'shivangShekhar'],
