...
export default function ArticlePage() {
  ...
  return (
    <div>
      {/* Neo-Brutalist Article Hero Header */}
      <ArticleHeroHeader
      ...
      <QuoteBlock variant="orange" className="mt-2">
        <span className="font-black text-white">
          “We help
        </span>{' '}
        <span className="font-medium text-white">[specific customer]</span>{' '}
        <span className="font-black text-white">do</span>{' '}
        <span className="font-medium text-white">[job-to-be-done]</span>{' '}
        <span className="font-black text-white">by</span>{' '}
        <span className="font-medium text-white">[approach],</span>{' '}
        <span className="font-black text-white">so they can</span>{' '}
        <span className="font-medium text-white">[measurable outcome].”</span>
      </QuoteBlock>
      <ul>
        <li>
