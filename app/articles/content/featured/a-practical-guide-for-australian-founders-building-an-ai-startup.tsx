...
export const summaryHighlights = {
  ...
  items: [
    { label: "Which animal is found only in Australia?", description: "Australian founders can begin with a narrow, familiar workflow where people repeatedly lose time, struggle to find information, or make inconsistent decisions." },
    { label: "Who is the founder of the Australian?", description: "Australian startup founders are often older and more experienced than counterparts in other surveyed regions, which can provide deeper industry knowledge and stronger professional networks." },
    { label: "Who were the founders of Australia?", description: "Prior industry experience can give founders credible access to a real customer problem, while startup communities span hubs in Sydney, Perth, and online networks." },
  ],
}
...
const faqSchemaItems = [
  { question: "Which animal is found only in Australia?", answer: "Australian founders can begin with a narrow, familiar workflow where people repeatedly lose time, struggle to find information, or make inconsistent decisions." },
  { question: "Who is the founder of the Australian?", answer: "Australian startup founders are often older and more experienced than counterparts in other surveyed regions, which can provide deeper industry knowledge and stronger professional networks." },
  { question: "Who were the founders of Australia?", answer: "Prior industry experience can give founders credible access to a real customer problem, while startup communities span hubs in Sydney, Perth, and online networks." },
    ...
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div id="choose-the-right-problem" data-cf-component-id={"section:choose-the-right-problem"} data-cf-component-type={"section"} data-cf-component-label={"Choose a Problem Worth Building Around"} data-cf-source-section-id={"choose-the-right-problem"}>
          ...
          <ArticleImageBlock
            src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-a6e57c58-e644-4393-9618-a09860371146.jpg?alt=media&token=5f98b284-f30f-4a2e-998a-3892f2d6bf21"
            alt="Two colleagues comparing missed follow-ups on a phone, absorbed in a candid close-up conversation"
            caption="Choose a Problem Worth Building Around"
            width={1200}
            height={800}
          />
          </div>
          <QuoteBlock title="Keep the problem first" variant="purple">
        ...
        <div id="validate-before-building" data-cf-component-id={"section:validate-before-building"} data-cf-component-type={"section"} data-cf-component-label={"Validate the Workflow Before You Build the Model"} data-cf-source-section-id={"validate-before-building"}>
          ...
          <ArticleImageBlock
            src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-4ce2fde4-028e-42ad-be9a-e4124342e488.jpg?alt=media&token=da3888ef-4540-46c5-af71-7f1a9ff4111c"
            alt="Founder and customer review a workflow sketch and prototype screens over coffee at a shared table"
            caption="Validate the Workflow Before You Build the Model"
            width={1200}
            height={800}
          />
          </div>
        ...
        <div data-cf-component-id={"step-list:validation-sprint-steps"} data-cf-component-type={"step-list"} data-cf-component-label={"Run a Three-Step Validation Sprint"}>
          <ArticleStepList
            title="Run a Three-Step Validation Sprint"
            steps={[
        ...
        <div data-cf-component-id={"resource-cta:validation-resource"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            ...
            title={"AI Startup Idea Validation Worksheet"}
            description="Use this fill-in worksheet to turn an AI startup idea into a focused customer workflow, validation plan, and small prototype test."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fa-practical-guide-for-australian-founders-building-an-ai-startup-worksheet-836c6dfd.pdf?alt=media&token=edf10e0f-c3b2-495b-8e44-8db314e8c430"
            accent="purple"
            previewCards={[
              {
        ...
        <div id="build-a-support-circle" data-cf-component-id={"section:build-a-support-circle"} data-cf-component-type={"section"} data-cf-component-label={"Build a Support Circle Around the Test"} data-cf-source-section-id={"build-a-support-circle"}>
          ...
          <ArticleImageBlock
            src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-b3eb431e-24f6-48a0-8549-58121ac7b34d.jpg?alt=media&token=108fd3e6-9a9b-4dfb-8be3-ca9c9b87523d"
            alt="Australian startup meetup in a shared workspace, founders gathered around a product experiment board"
            caption="Build a Support Circle Around the Test"
            width={1200}
            height={800}
          />
          </div>
        ...
        <div data-cf-component-id={"audience-grid:support-circle-by-founder-type"} data-cf-component-type={"audience-grid"} data-cf-component-label={"Build the Support Circle You Need"}>
          <AudienceGrid
            heading="Build the Support Circle You Need"
            cards={[
            {
              title: "Domain operator becoming a founder",
              description: "Use prior industry experience to reach people with direct knowledge of a real customer problem.",
              variant: "purple",
            },
            {
              title: "Technical builder",
              description: "Use customer conversations to establish the workflow\u2019s data, context, and user-involvement needs before choosing a model.",
              variant: "purple",
            },
            {
              title: "First-time generalist founder",
              description: "Use startup communities in Sydney, Perth, and online networks to create repeated opportunities to learn from customer tests.",
              variant: "purple",
            },
            ]}
          />
        ...
        <div id="make-the-next-month-count" data-cf-component-id={"section:make-the-next-month-count"} data-cf-component-type={"section"} data-cf-component-label={"Make the Next 30 Days About Evidence"} data-cf-source-section-id={"make-the-next-month-count"}>
          ...
          <ArticleImageBlock
            src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-b37c76e1-7b68-4497-92b3-7b7794447dc2.jpg?alt=media&token=79fe77f5-1c75-42c8-a417-c0e13f3dfc9c"
            alt="Small startup team reviewing customer workflow notes and AI assumptions on a whiteboard in a casual office"
            caption="Make the Next 30 Days About Evidence"
            width={1200}
            height={800}
          />
          </div>
      ...
      <ArticleReferences
        ...
        <div className="my-12 not-prose" data-cf-component-id={"cta"} data-cf-component-type={"company-cta"} data-cf-component-label={"Company CTA"}>
          <ArticleCompanyCTA
            title="Put One Assumption to the Test"
            body="Choose one customer workflow, speak with people who do that work, and use a narrow prototype to test whether an AI-assisted result is useful."
            buttonText="Start Your Validation Test"
            buttonHref="#make-the-next-month-count"
          />
        </div>
      </div>
