...
export const faqItems: FAQ[] = [
  { id: 1, question: "Why are Sydney startups becoming important for AI builders?", answer: "Sydney startups are becoming important for AI builders because the city combines practical startup infrastructure with AI-focused communities. MLAI helps Australian AI founders connect with peers, mentors and operators, including access to free coworking space at Stone & Chalk in Tech Central for early-stage Australian startup founders." },
  { id: 2, question: "Where can AI builders find community in Sydney?", answer: "AI builders can find community through MLAI, startup directories and university-linked founder programs. MLAI connects builders, learners and founders with peers and mentors, and includes access to free coworking space at Stone & Chalk in Tech Central for early-stage Australian startup founders." },
...
const faqSchemaItems = [
  ...
  { question: "Why are Sydney startups becoming important for AI builders?", answer: "Sydney startups are becoming important for AI builders because the city combines practical startup infrastructure with AI-focused communities. MLAI helps Australian AI founders connect with peers, mentors and operators, including access to free coworking space at Stone & Chalk in Tech Central for early-stage Australian startup founders." },
  { question: "Where can AI builders find community in Sydney?", answer: "AI builders can find community through MLAI, startup directories and university-linked founder programs. MLAI connects builders, learners and founders with peers and mentors, and includes access to free coworking space at Stone & Chalk in Tech Central for early-stage Australian startup founders." },
    ...
    <>
      ...
      <ArticleReferences
        ...
        <div className="my-12 not-prose" data-cf-component-id={"cta"} data-cf-component-type={"company-cta"} data-cf-component-label={"Company CTA"}>
          <ArticleCompanyCTA
            title="Build with the Australian AI community"
            body="Join MLAI to meet AI builders, learners and founders working on practical projects across the growing Australian AI ecosystem."
