...
export const summaryHighlights = {
  ...
  items: [
    ...
    { label: "What are the top 10 startups?", description: "A useful Sydney AI startup shortlist should be based on current directories and sector fit, not a fixed ranking. UNSW Founders examples show activity across procurement, robotics, education, real estate and health-adjacent technology." },
  ],
}
...
const faqSchemaItems = [
  ...
  { question: "What are the top 10 startups?", answer: "A useful Sydney AI startup shortlist should be based on current directories and sector fit, not a fixed ranking. UNSW Founders examples show activity across procurement, robotics, education, real estate and health-adjacent technology." },
  { question: "Why are Sydney startups becoming important for AI builders?", answer: "Sydney startups are becoming important for AI builders because the city combines practical startup infrastructure with AI-focused communities. Examples include the Sydney Startup Guide and AI Builder Club\u2019s Sydney CBD residency model." },
    ...
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div id="section-02" data-cf-component-id={"section:section-02"} data-cf-component-type={"section"} data-cf-component-label={"Why Sydney startups are organising around AI builders"} data-cf-source-section-id={"section-02"}>
          ...
          <p>{"The AI Builder Club is a clear example of this shift. SmartCompany describes it as a free six-week residency for Australian AI startups and AI project builders, based in the Sydney CBD. Its model is inspired by builder-heavy communities such as Cerebral Valley, where engineers-turned-entrepreneurs learn and build together. That matters because AI startup creation often starts before a polished company exists. It can begin with engineers, enthusiasts, mentors, and peers testing ideas in the same room."}</p>
        ...
        <div data-cf-component-id={"resource-cta"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            ...
            title={"Sydney AI Builder Validation Checklist"}
            description="Use this checklist to define your AI problem, find trusted Sydney startup signals, gather feedback through communities, and validate before raising."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fsydney-startups-are-building-australia-s-ai-builder-community-checklist-ee261bf6.pdf?alt=media&token=221922b5-f8ab-44cd-b70d-e5513d5a43a7"
            accent="purple"
            previewCards={[
              {
                title: "Pre-raise checks",
                subtitle: 'PDF',
                color: "bg-[#ff3d00]",
