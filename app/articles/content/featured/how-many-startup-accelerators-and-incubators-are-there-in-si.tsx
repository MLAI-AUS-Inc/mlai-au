...
// Note: ArticleFAQ, ArticleLayout, etc. are handled by the route wrapper now, 
// but we export `faqItems` for the route to pick up.
...
// Signal to the route handler to use custom headers/layouts if supported
...
export default function ArticlePage() {
  ...
  const summaryHighlights = {
    heading: 'Key Facts',
    intro: 'Singapore’s accelerator/incubator landscape changes each year. Use ranges, verify activity (2025/2026), and check terms before you apply.',
    items: [
      {
  ...
  // Author details are now handled by the registry/route, but we can pass them to AuthorBio if we use it manually.
  // Although ArticleLayout usually handles it.
  const authorDetails = {
    name: AUTHOR,
    role: AUTHOR_PROFILE?.role,
    bio: AUTHOR_PROFILE?.bio,
    avatarUrl: AUTHOR_PROFILE?.avatarUrl
  }
  ...
  return (
    <>
      ...
      <ArticleTocPlaceholder className="mb-12">
        {/* Rendered via portal by ArticleEnhancer in the parent layout */}
        ...
        cards={[
          {
            ...
            description: 'Scoping Singapore options? Use a shortlist-and-verify approach before committing equity or fees.',
            variant: 'orange',
            // Simple Rocket Icon
            icon: (
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-white">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84p4.8m7.381-5.84a14.926 14.926 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
              </svg>
            )
          },
          {
            title: 'Students & Switchers',
            description: 'Look for non-dilutive incubators and university-linked programmes if you’re pre-idea or portfolio-building.',
            variant: 'yellow',
            // Graduation Cap Icon
            icon: (
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-black">
          ...
          },
          {
            ...
            description: 'Map sector-specific options (AI, health, fintech) and track demo days to spot current activity.',
            variant: 'purple',
      ...
      <div className="">
        ...
        <ArticleImageBlock
          src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-506e017c-dedf-4f20-9206-fc5b5d055142.jpg?alt=media&token=c0039b0e-29d6-46dc-b3a8-2a8d38ac2334"
          alt="People collaborating in a retro 90s tech startup, embodying creativity and innovation in a vibrant workspace."
        />
        ...
        <ArticleImageBlock
          src="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-b192f8d9-7935-4a4f-81b1-efd30fd1bf12.jpg?alt=media&token=70feb145-fb1e-457e-baed-26c3161a869a"
          alt="People collaborating in a tech startup setting with a nostalgic 90s film aesthetic."
        />
