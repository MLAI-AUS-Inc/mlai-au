  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"resource-cta:accelerator-checklist-cta"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            eyebrow="Free scorecard"
            title={"Melbourne Accelerator Program Fit Scorecard"}
            description="A printable scorecard to help AI founders decide whether to apply to MAP now, wait, or look for a different accelerator fit."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fhow-to-choose-a-melbourne-accelerator-program-for-ai-startups-scorecard-8c6546af.pdf?alt=media&token=9f020452-524a-4d57-9714-0b8c5aabecec"
            accent="purple"
            previewCards={[
              {
                title: "Apply vs Wait",
      ...
      <ArticleReferences
        ...
        <div className="my-12 not-prose" data-cf-component-id={"cta"} data-cf-component-type={"company-cta"} data-cf-component-label={"Company CTA"}>
          <ArticleCompanyCTA
            title="Build your accelerator fit checklist"
            body="Compare stage, eligibility, support needs, AI-specific blockers, funding value, and application timing before choosing whether to apply, wait, or look for another pathway."
            buttonText="Download the checklist"
            buttonHref="#accelerator-checklist"
          />
        </div>
      </div>
