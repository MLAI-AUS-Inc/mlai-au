    ...
    <>
      ...
      <div className="my-4 rounded-lg border border-indigo-200 bg-indigo-50 p-4">
        <p className="text-sm text-indigo-900">
          ...
          <Link to="/articles/featured/ai-startup-foundations" className="font-semibold text-[#1028E0] hover:underline">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          ...
          and <Link to="/resources" className="font-medium text-[#1028E0] hover:underline">resources</Link>.
        </p>
