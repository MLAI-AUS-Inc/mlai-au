...
export const summaryHighlights = {
  ...
  intro: "Australian startups grow through stronger AI communities that connect founders with talent, technical feedback, research, users and responsible AI practice.",
  items: [
    { label: "What are the top 10 startups?", description: "This article does not rank the top 10 startups. It focuses on why Australian startups, including AI-enabled companies, need stronger communities to turn funding, talent and experimentation into durable growth." },
    { label: "What are the top startups in Aus?", description: "LinkedIn\u2019s 2025 Top Startups list highlights Australian startups investing in people and long-term careers. The article uses that momentum to explain why community support still matters." },
    { label: "What business can I start with $100K in Australia?", description: "The article does not recommend a specific business to start with $100K. It explains that AI tools are more accessible, but founders still need feedback, talent pathways and trusted market learning." },
  ],
}
...
const faqSchemaItems = [
  { question: "What are the top 10 startups?", answer: "This article does not rank the top 10 startups. It focuses on why Australian startups, including AI-enabled companies, need stronger communities to turn funding, talent and experimentation into durable growth." },
  { question: "What are the top startups in Aus?", answer: "LinkedIn\u2019s 2025 Top Startups list highlights Australian startups investing in people and long-term careers. The article uses that momentum to explain why community support still matters." },
  { question: "What business can I start with $100K in Australia?", answer: "The article does not recommend a specific business to start with $100K. It explains that AI tools are more accessible, but founders still need feedback, talent pathways and trusted market learning." },
  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"quote:momentum-insight"} data-cf-component-type={"quote"} data-cf-component-label={"Key insight"}>
        ...
        <div data-cf-component-id={"resource-cta"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            ...
            title={"AI Startup Community Feedback Checklist"}
            description="Use this printable checklist before and after AI community events to turn conversations into sharper assumptions, better feedback, and useful follow-up."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fwhy-australian-startups-need-stronger-ai-communities-checklist-d9bf366e.pdf?alt=media&token=8150653d-01c6-4fa3-9d3a-bc7d883d2fce"
            accent="purple"
            previewCards={[
              {
