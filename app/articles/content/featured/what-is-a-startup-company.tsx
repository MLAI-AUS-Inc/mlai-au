  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"quote:scalable-model-insight"} data-cf-component-type={"quote"} data-cf-component-label={"Key insight"}>
        ...
        <div data-cf-component-id={"resource-cta:validation-resource-slot"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            eyebrow="Free worksheet"
            title={"AI Startup Validation Worksheet"}
            description="Use this worksheet to define the customer problem, test whether your AI idea can scale, and decide what evidence you need before building, hiring, or raising funding."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fwhat-is-a-startup-company-worksheet-f1f4b6c0.pdf?alt=media&token=ecc8bc35-63bb-48ef-b4a5-4c583ea90408"
            accent="purple"
            previewCards={[
              {
                title: "Startup fit test",
                subtitle: 'PDF',
                color: "bg-[#ff3d00]",
