...
export const DESCRIPTION = "MLAI guide to meetup websites for finding Australian AI and startup events."
...
export const summaryHighlights = {
  heading: "MLAI key facts: Meetup Websites for AI and Startup Communities in Australia",
  intro: "MLAI guide to meetup websites for finding Australian AI and startup events.",
  items: [
