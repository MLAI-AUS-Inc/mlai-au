  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"resource-cta:startup-readiness-checklist"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            eyebrow="Free worksheet"
            title={"AI Startup Validation Worksheet"}
            description="A fill-in worksheet to define your customer problem, AI-enabled value, proof-of-value test, growth path, funding fit, and riskiest assumption."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fwhat-is-a-startup-company-for-future-ai-founders-worksheet-76375af4.pdf?alt=media&token=b973e301-6c78-4bc6-8308-ebe460926d00"
            accent="purple"
            previewCards={[
              {
