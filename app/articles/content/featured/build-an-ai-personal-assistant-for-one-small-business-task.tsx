    ...
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div id="configure-example" data-cf-component-id={"section:configure-example"} data-cf-component-type={"section"} data-cf-component-label={"Configure an opening-hours drafting assistant"} data-cf-source-section-id={"configure-example"}>
          ...
          <p>{"Test with the fictional enquiry: \u201cAre you open on Sunday?\u201d An illustrative expected answer is: \u201cThanks for your enquiry. We are closed on Sundays. Our opening hours are Tuesday to Friday, 9 am to 5 pm, and Saturday, 9 am to noon.\u201d This expected answer was written for the exercise; it is not a captured model result."}</p>
        ...
        <div id="test-assistant" data-cf-component-id={"section:test-assistant"} data-cf-component-type={"section"} data-cf-component-label={"Test ordinary questions and situations it must flag"} data-cf-source-section-id={"test-assistant"}>
          ...
          <ArticleImageBlock
            ...
            alt="Test ordinary questions and situations it must flag"
            caption=""
            width={1200}
            height={800}
          />
      ...
      <ArticleReferences
          references={[
            ...
            {id: 4, href: "https://business.gov.au/online-and-digital/artificial-intelligence", title: "Artificial intelligence (AI) | business.gov.au", publisher: "business.gov.au", category: "guide"},
