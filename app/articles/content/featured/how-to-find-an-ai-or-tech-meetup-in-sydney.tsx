...
export const summaryHighlights = {
  ...
  intro: "Use these article-specific checks to choose a Sydney AI, tech or startup meetup.",
  items: [
    { label: "How do I find AI meetups in Sydney?", description: "Start with direct searches for AI, machine learning and data events, then widen to tech startup, founder, digital, UX, content strategy and small business communities where AI work may still be discussed." },
    { label: "What should I look for in a Sydney tech meetup?", description: "Check topic relevance, audience fit, format, cadence, organiser history, venue, suburb, date and registration details before you RSVP." },
    { label: "Are startup or small business meetups useful for AI networking?", description: "Yes. They can be useful when your goal is to meet founders, builders or operators who are testing tools, changing workflows or exchanging practical business lessons." },
  ],
}
...
const faqSchemaItems = [
  { question: "How do I find AI meetups in Sydney?", answer: "Start with direct searches for AI, machine learning and data events, then widen to tech startup, founder, digital, UX, content strategy and small business communities where AI work may still be discussed." },
  { question: "What should I look for in a Sydney tech meetup?", answer: "Check topic relevance, audience fit, format, cadence, organiser history, venue, suburb, date and registration details before you RSVP." },
  { question: "Are startup or small business meetups useful for AI networking?", answer: "Yes. They can be useful when your goal is to meet founders, builders or operators who are testing tools, changing workflows or exchanging practical business lessons." },
