...
export const summaryHighlights = {
  ...
  intro: "A practical guide to finding the right AI, tech, startup, or business networking room in Sydney.",
  items: [
    { label: "How do I find tech meetups in Sydney?", description: "Search for recurring AI, machine learning, data, software, product, startup, IT, and business communities. Prioritise current organiser activity, a clear audience, a practical format, and a location you can attend regularly." },
    { label: "Where can I meet AI founders and tech people in Sydney?", description: "Look beyond dedicated AI meetups. Startup, founder, product, data, software, web, and small business events can all be useful if your goal is to meet builders, customers, collaborators, or people using AI commercially." },
    { label: "Are tech meetups worth it for networking?", description: "They are worth it when the room matches your goal. A smaller event with relevant people, useful prompts, and good follow-up opportunities is usually more valuable than a large, general networking night." },
  ],
}
...
const faqSchemaItems = [
  { question: "How do I find tech meetups in Sydney?", answer: "Search for recurring AI, machine learning, data, software, product, startup, IT, and business communities. Prioritise current organiser activity, a clear audience, a practical format, and a location you can attend regularly." },
  { question: "Where can I meet AI founders and tech people in Sydney?", answer: "Look beyond dedicated AI meetups. Startup, founder, product, data, software, web, and small business events can all be useful if your goal is to meet builders, customers, collaborators, or people using AI commercially." },
  { question: "Are tech meetups worth it for networking?", answer: "They are worth it when the room matches your goal. A smaller event with relevant people, useful prompts, and good follow-up opportunities is usually more valuable than a large, general networking night." },
