      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 prose-headings:text-gray-900 hover:prose-a:text-[--brand]">
          ...
          <p>
            ...
            infra and security talent. Use current disclosed job advertisements and multiple salary sources rather than relying on a single range. Always
            confirm superannuation and equity terms in writing.
          </p>
