...
export const summaryHighlights = {
  heading: "Key facts: What Community Is in AI and Why It Is More Than a Group",
  intro: "What community is in AI: shared purpose, trust and participation.",
  items: [
    { label: "What is the definition of community?", description: "A community is a social group connected by meaningful common ground, such as shared values, norms, identity, place, or purpose. It is sustained through relationships and ongoing participation." },
    { label: "What is the definition of a community?", description: "A community is more than a collection of members because people share socially meaningful connections and ways of participating. In AI, it forms around shared learning, work, or practice." },
    { label: "What is community for example?", description: "An AI community can be people who regularly learn a tool together, discuss a common challenge, and share practical lessons. Their repeated exchanges, not the platform, create the community." },
  ],
}
...
const faqSchemaItems = [
  { question: "What is the definition of community?", answer: "A community is a social group connected by meaningful common ground, such as shared values, norms, identity, place, or purpose. It is sustained through relationships and ongoing participation." },
  { question: "What is the definition of a community?", answer: "A community is more than a collection of members because people share socially meaningful connections and ways of participating. In AI, it forms around shared learning, work, or practice." },
  { question: "What is community for example?", answer: "An AI community can be people who regularly learn a tool together, discuss a common challenge, and share practical lessons. Their repeated exchanges, not the platform, create the community." },
  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"quote:trust-is-human"} data-cf-component-type={"quote"} data-cf-component-label={"Key insight"}>
