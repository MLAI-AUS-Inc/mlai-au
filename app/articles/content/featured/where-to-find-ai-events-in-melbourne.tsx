...
export const faqItems: FAQ[] = [
  ...
  { id: 2, question: "Are there AI centres in Australia that connect to Melbourne events?", answer: "AI at Melbourne is a research community based at Melbourne Connect, bringing together artificial intelligence experts across technical, healthcare, engineering and social science fields." },
  ...
  { id: 4, question: "How should you choose between a conference, research event and builder meetup?", answer: "Choose a conference for enterprise adoption and governance, a research event for technical depth, and a builder meetup for practical work, demos and peer learning." },
]
...
export const summaryHighlights = {
  ...
  items: [
    ...
    { label: "Where can you find research-led AI events in Melbourne?", description: "Melbourne Connect hosts AI at Melbourne, a research community spanning machine learning, natural language processing, robotics, ethical AI, healthcare, engineering and social sciences." },
    { label: "How do you find AI meetups and hackathons in Melbourne?", description: "Builder-community calendars can list AI builders meetups, hackathons, demo nights and build sessions, but each event page should confirm the city, venue, time zone and registration status." },
  ],
}
...
const faqSchemaItems = [
  ...
  { question: "Where can you find research-led AI events in Melbourne?", answer: "Melbourne Connect hosts AI at Melbourne, a research community spanning machine learning, natural language processing, robotics, ethical AI, healthcare, engineering and social sciences." },
  { question: "How do you find AI meetups and hackathons in Melbourne?", answer: "Builder-community calendars can list AI builders meetups, hackathons, demo nights and build sessions, but each event page should confirm the city, venue, time zone and registration status." },
  ...
  { question: "Are there AI centres in Australia that connect to Melbourne events?", answer: "AI at Melbourne is a research community based at Melbourne Connect, bringing together artificial intelligence experts across technical, healthcare, engineering and social science fields." },
  ...
  { question: "How should you choose between a conference, research event and builder meetup?", answer: "Choose a conference for enterprise adoption and governance, a research event for technical depth, and a builder meetup for practical work, demos and peer learning." },
]
  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <p>{"Melbourne also has research and builder activity beyond major conferences. Melbourne Connect describes AI at Melbourne as a research community spanning machine learning, natural language processing, robotics, ethical AI, healthcare, engineering, and social sciences. Builder meetups and hackathons can be useful for practical learning and networking, but dates and details may change, so check the organiser page before you plan around them."}</p>
        </div>
        ...
        <div id="research-hubs" data-cf-component-id={"section:research-hubs"} data-cf-component-type={"section"} data-cf-component-label={"Check Melbourne Connect for research-led AI activity"} data-cf-source-section-id={"research-hubs"}>
          <h2>{"Check Melbourne Connect for research-led AI activity"}</h2>
          <p>{"Melbourne Connect is a useful place to watch if you want AI events Melbourne audiences can connect to deeper research activity. Its AI at Melbourne community is described as a research community based at Melbourne Connect, bringing together experts in artificial intelligence. The work spans machine learning, natural language processing, robotics and ethical AI, with links across computer science, engineering, healthcare and the social sciences."}</p>
          <p>{"Researchers and clinicians can find adjacent expertise. If your goal is depth, expert networks or early insight into real-world AI challenges, Melbourne Connect should be on your shortlist."}</p>
          <div data-cf-component-id={"image:research-hubs"} data-cf-component-type={"image"} data-cf-component-label={"Image: Check Melbourne Connect for research-led AI activity"} data-cf-source-section-id={"research-hubs"}>
          <ArticleImageBlock
            ...
            alt="Researchers discuss AI projects at laptops in a Melbourne Connect university innovation precinct event"
            caption="Research-led AI events can help you find technical depth, expert networks and applied collaborators."
            width={1200}
            height={800}
          />
          </div>
          <QuoteBlock title="Tip" variant="purple">
            {"Choose research-led events when you want technical depth, collaborators or early insight into applied AI problems."}
          </QuoteBlock>
        </div>
        <div id="builder-communities" data-cf-component-id={"section:builder-communities"} data-cf-component-type={"section"} data-cf-component-label={"Follow builder communities for meetups, hackathons and demos"} data-cf-source-section-id={"builder-communities"}>
          <h2>{"Follow builder communities for meetups, hackathons and demos"}</h2>
          <p>{"Formal conference lists are useful, but they can miss smaller builder-led AI events in Melbourne. Builder communities often publish their own calendars for practical formats such as AI builders meetups, hackathons, build sessions, code labs, tech talks, networking nights and fireside conversations. These events are often closer to the work of building, testing and sharing AI projects than a large conference program."}</p>
          <p>{"Build Club is a good example of the type of calendar to watch, because its listings show formats such as a Cursor hackathon, an AI builders meetup, a build-focused session and fireside chats. Those examples are not Melbourne-specific listings, which is the point: community calendars can mix local, interstate, international and online events. Search with format-led terms such as \u201cAI builders meetup\u201d, \u201cAI hackathon\u201d, \u201cdemo night\u201d and \u201cbuild session\u201d, then open the event page and confirm the city, venue or online format, time zone, prerequisites and registration status before you plan around it."}</p>
          <div data-cf-component-id={"image:builder-communities"} data-cf-component-type={"image"} data-cf-component-label={"Image: Follow builder communities for meetups, hackathons and demos"} data-cf-source-section-id={"builder-communities"}>
          <ArticleImageBlock
            ...
            caption="Builder-community calendars can surface hands-on AI meetups, hackathons and build sessions."
            width={1200}
            height={800}
          />
          </div>
          <QuoteBlock title="Check the location before you register" variant="purple">
            {"Do not assume a builder-community listing is in Melbourne until the event page confirms the city, venue or online format."}
          </QuoteBlock>
        </div>
        <div data-cf-component-id={"resource-cta:event-shortlist-resource"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the resource"}>
          <ArticleResourceCTA
            ...
            title={"Melbourne AI Event Fit Scorecard"}
            description="A printable scorecard to help you choose the right Melbourne AI event by outcome, format, practical details and follow-up value."
            buttonLabel="Download the PDF"
            buttonHref="https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fresources%2Fwhere-to-find-ai-events-in-melbourne-scorecard-fbe553a0.pdf?alt=media&token=605768dc-66bf-42d1-882d-a16faab3787f"
            accent="purple"
            previewCards={[
              {
                title: "Event fit scores",
                subtitle: 'PDF',
                color: "bg-[#ff3d00]",
        ...
        <div id="choose-by-outcome" data-cf-component-id={"section:choose-by-outcome"} data-cf-component-type={"section"} data-cf-component-label={"Choose by outcome before you register"} data-cf-source-section-id={"choose-by-outcome"}>
          ...
          <p>{"If you want technical depth or research connections, Melbourne Connect is a better fit. Its AI community is described around research, machine learning, natural language processing, robotics, ethical AI, and interdisciplinary collaboration. That makes it useful when you want to meet researchers, understand emerging methods, or find collaborators across fields such as computer science, engineering, healthcare, and the social sciences."}</p>
          <p>{"Build Club describes itself around learning to build with AI and lists hackathons, builder meetups, launch nights, and fireside chats. Those formats are usually better when you want to make something, compare notes with other builders, or stay close to practical AI work."}</p>
          ...
          <p>{"Define your goal, such as adoption, research, hiring, learning, or building. Check the audience, because an enterprise summit, a research hub, and a builder meetup will attract different people. Match the format to your energy level: conference sessions suit broad learning, research activity suits deeper exploration, and hackathons or meetups suit practical work."}</p>
        </div>
        <div id="conclusion" data-cf-component-id={"section:conclusion"} data-cf-component-type={"section"} data-cf-component-label={"Build a repeatable Melbourne AI event habit"} data-cf-source-section-id={"conclusion"}>
          ...
          <p>{"The best way to use AI events in Melbourne is to build a simple repeatable habit. A conference such as The AI Summit Australia or Enterprise AI Melbourne can help you see business use cases, production lessons, governance themes, and where enterprise AI is heading. A research hub such as AI at Melbourne can keep you closer to machine learning, natural language processing, robotics, and ethical AI work."}</p>
          <p>{"Build Club shows why this matters: builder calendars can include hackathons and local launch events, but dates may change. Before each event, arrive with a question, a project idea, or one person you want to meet. After the event, follow up while the discussion is still fresh."}</p>
          ...
          <ul>
            ...
            <li>{"Follow one research-led Melbourne AI source for deeper technical context."}</li>
            <li>{"Join one builder-community channel for meetups, hackathons, and practical sessions."}</li>
          </ul>
        </div>
      ...
      <ArticleReferences
          references={[
            ...
            {id: 3, href: "https://www.melbconnect.com.au/ai-melbourne", title: "Melbourne Connect | Melbourne Connect | Melbourne AI Innovations &\u2026", publisher: "melbconnect.com.au", description: "Authoritative reference supporting Melbourne Connect | Melbourne Connect | Melbourne AI Innovations &\u2026.", category: "guide"},
            {id: 4, href: "https://www.aicamp.ai/event/eventdetails/W2026041323", title: "Learn AI with global developers community | AICamp", publisher: "aicamp.ai", description: "Authoritative reference supporting Learn AI with global developers community | AICamp.", category: "guide"},
            ...
            {id: 7, href: "https://campus.buildclub.ai/events", title: "Build Club", publisher: "campus.buildclub.ai", description: "Authoritative reference supporting Build Club.", category: "guide"},
          ]}
        ...
        <div className="my-12 not-prose" data-cf-component-id={"cta"} data-cf-component-type={"company-cta"} data-cf-component-label={"Company CTA"}>
          <ArticleCompanyCTA
            title="Stay close to Australia\u2019s AI builder community"
            body="MLAI helps founders, practitioners and teams connect around practical AI work, learning and community participation across Australia."
