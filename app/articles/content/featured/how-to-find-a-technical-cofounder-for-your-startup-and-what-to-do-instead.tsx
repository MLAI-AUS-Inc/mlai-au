  ...
  return (
    <article className="bg-transparent">
      ...
      <section className="mx-auto max-w-[1220px] mt-0" id="do-you-really-need-one">
        <h2 className="font-oswald text-3xl font-semibold">{"Do You Really Need a Technical Cofounder on Day One?"}</h2>
      ...
      <section className="mx-auto max-w-[1220px] mt-0" id="where-to-look">
        <h2 className="font-oswald text-3xl font-semibold">{"Where to Look for Your Technical Partner"}</h2>
      ...
      <section className="mx-auto max-w-[1220px] mt-0" id="how-to-evaluate">
        <h2 className="font-oswald text-3xl font-semibold">{"How to Pitch and Evaluate a Potential Technical Cofounder"}</h2>
      ...
      <section className="mx-auto max-w-[1220px] mt-0" id="conclusion">
        <h2 className="font-oswald text-3xl font-semibold">{"Keep Moving Forward: Don't Let the Search Stall Your Startup"}</h2>
