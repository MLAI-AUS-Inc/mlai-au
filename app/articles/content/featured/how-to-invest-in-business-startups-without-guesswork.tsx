...
export const faqItems: FAQ[] = [
  ...
  { id: 2, question: "Where can investors find startup opportunities?", answer: "Investors can find startup opportunities through startup communities such as MLAI, where founders, operators, mentors, and ecosystem partners already gather. MLAI can help investors create warmer introductions and a more consistent source of deal flow through events, community programs, and founder-facing activity." },
...
export const summaryHighlights = {
  ...
  items: [
    ...
    { label: "Is it true that 90% of startups fail?", description: "Yes, broadly. The 90% figure is a commonly cited shorthand for how risky startups can be, not a guarantee for every market or cohort. Treat it as a warning to diversify, verify documents and numbers, and invest only money you can afford to lose." },
  ],
}
...
const faqSchemaItems = [
  ...
  { question: "Is it true that 90% of startups fail?", answer: "Yes, broadly. The 90% figure is a commonly cited shorthand for how risky startups can be, not a guarantee for every market or cohort. Treat it as a warning to diversify, verify documents and numbers, and invest only money you can afford to lose." },
  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div className="mt-12" data-cf-component-id={"audience-grid:audience-lanes"} data-cf-component-type={"audience-grid"} data-cf-component-label={"Choose your startup investing lane"}>
          <AudienceGrid
        ...
        <div id="find-deal-flow" data-cf-component-id={"section:find-deal-flow"} data-cf-component-type={"section"} data-cf-component-label={"Find deal flow where startups already gather"} data-cf-source-section-id={"find-deal-flow"}>
          ...
          <p>{"MLAI is a practical example of this kind of gathering point. Its events, community programs, and founder-facing activity can put investors closer to startups before a formal raise, creating warmer introductions and a more consistent source of deal flow than waiting for cold pitch decks."}</p>
