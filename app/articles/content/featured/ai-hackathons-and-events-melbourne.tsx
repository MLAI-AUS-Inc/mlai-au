...
const DESCRIPTION = 'A practical 2026 guide to AI hackathons and community events in Melbourne: formats, venues, costs, judging, and how to prepare.'
        ...
        <QuoteBlock variant="purple" className="mt-8">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3 text-white/90">
              ...
              <span>Find an upcoming hackathon or AI event in Melbourne that matches your skill level.</span>
            </li>
            <li className="flex gap-3 text-white/90">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/20 text-xs font-bold text-white">
                2
              </span>
              <span>Assemble a balanced team—one builder, one designer/UX, one pitch lead—before you register.</span>
            </li>
            <li className="flex gap-3 text-white/90">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/20 text-xs font-bold text-white">
                3
              </span>
              <span>Pre-test your API keys and prepare a starter kit so you can hit the ground running.</span>
            </li>
          </ul>
        </QuoteBlock>
