...
export const DESCRIPTION = "Why are volunteers important to the community? See how they add capacity, care, skills, connection, and resilience to local groups and learning networks."
...
export const summaryHighlights = {
  heading: "Key facts: Why Are Volunteers Important to the Community?",
  intro: "Why are volunteers important to the community? See how they add capacity, care, skills, connection, and resilience to local groups and learning networks.",
  items: [
    { label: "Why are volunteers so important to the community?", description: "Volunteers give unpaid time, care, and skills where paid resources are limited. They help organisations run services, support people, and build stronger social connection." },
    { label: "How do volunteers contribute to the community?", description: "They contribute through formal roles with charities or informal help for neighbours, friends, and family. Their work can include mentoring, events, fundraising, governance, training, and peer support." },
    { label: "What are the 5 core values of a volunteer?", description: "The article highlights service, respect, reliability, empathy, and willingness to learn. These values help volunteers stay useful, trusted, and responsive to real community needs." },
  ],
}
    ...
    <>
      ...
      <div className="prose prose-lg prose-slate max-w-none bg-transparent">
        ...
        <div data-cf-component-id={"resource-cta"} data-cf-component-type={"resource-cta"} data-cf-component-label={"Get the checklist"}>
          <ArticleResourceCTA
            eyebrow="Free guide"
            title={"Get the why are volunteers important to the community checklist"}
