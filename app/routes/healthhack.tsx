...
export const meta: MetaFunction = () => {
  return [
    { title: "HealthHack — Information Pack | MLAI" },
    {
      name: "description",
      content:
        "Everything you need to know about HealthHack. Explore the schedule, challenge tracks, judging criteria, mentors, venue details, and event policies.",
    },
    { property: "og:title", content: "HealthHack — Information Pack" },
    {
      property: "og:description",
      content:
        "Join clinicians, builders and optimists for one intense weekend of healthcare problem-solving.",
    },
  ];
};
...
export default function MedhackInfoPack() {
  return (
    <div className="healthhack-app min-h-screen">
      {/* Mobile TOC */}
      <div className="lg:hidden pl-14 pr-4 pt-6">
