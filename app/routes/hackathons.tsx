            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12 max-w-5xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <a
                            href="/platform/login?app=innovate-connect-alliance&next=/innovate-connect-alliance"
                            className="group relative block aspect-video overflow-hidden rounded-2xl bg-white shadow-lg transition-transform duration-200 hover:-translate-y-1"
                        >
                            <img
                                src={ICA_STATIC}
                                alt="Innovate Connect Alliance"
                                className="absolute inset-0 h-full w-full object-cover object-center transition-transform duration-500 group-hover:scale-105"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/20 to-transparent" />
                            <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-10">
                                <h3 className="text-2xl font-bold">Innovate Connect Alliance</h3>
                                <p className="mt-2 text-sm text-gray-200">
                                    Build as a team, shape the story, and upload your final concept video.
                                </p>
                            </div>
                        </a>
                    </div>
