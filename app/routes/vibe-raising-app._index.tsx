...
import { getVibeRaisingMonthlyUpdatesBundle, getVibeRaisingLoginHref, resolveActiveCompanyId, getVibeRaisingInputSourcesForRequest } from "~/lib/vibe-raising";
...
export async function loader({ request, context }: Route.LoaderArgs) {
  ...
  const { authUser, appUser: user } = await getOptionalVibeRaisingContextForLoader(context, request);
