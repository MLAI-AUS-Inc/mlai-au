...
const MLAI_MONTH_THEMES = {
    mint: {
        tabClass: "bg-[var(--vr-color-primary)] shadow-[rgba(107,48,217,0.24)]",
        borderClass: "border-[rgba(107,48,217,0.38)]",
        ringClass: "ring-[rgba(107,48,217,0.16)]",
        softClass: "bg-[var(--vr-color-primary-soft)]",
        inputClass: "border-[rgba(107,48,217,0.38)] focus:border-[var(--vr-color-primary)]",
    ...
    teal: {
        tabClass: "bg-[var(--vr-palette-teal)] shadow-[rgba(0,200,204,0.24)]",
        borderClass: "border-[rgba(0,200,204,0.45)]",
        ringClass: "ring-[rgba(0,200,204,0.14)]",
        softClass: "bg-[rgba(0,200,204,0.08)]",
        inputClass: "border-[rgba(0,200,204,0.45)] focus:border-[var(--vr-palette-teal)]",
        textClass: "text-white",
        mutedTextClass: "text-white/75",
    ...
    orange: {
        tabClass: "bg-[var(--vr-palette-orange)] shadow-[rgba(232,69,33,0.24)]",
        borderClass: "border-[rgba(232,69,33,0.45)]",
        ringClass: "ring-[rgba(232,69,33,0.14)]",
        softClass: "bg-[rgba(232,69,33,0.08)]",
        inputClass: "border-[rgba(232,69,33,0.45)] focus:border-[var(--vr-palette-orange)]",
        textClass: "text-white",
        mutedTextClass: "text-white/75",
        dividerClass: "border-white/30",
        hoverClass: "hover:bg-white/10",
    ...
    coral: {
        tabClass: "bg-[var(--vr-palette-coral)] shadow-[rgba(232,69,33,0.24)]",
        borderClass: "border-[rgba(232,69,33,0.45)]",
        ringClass: "ring-[rgba(232,69,33,0.14)]",
        softClass: "bg-[rgba(232,69,33,0.10)]",
        inputClass: "border-[rgba(232,69,33,0.45)] focus:border-[var(--vr-palette-coral)]",
        textClass: "text-[var(--vr-palette-black)]",
        mutedTextClass: "text-black/65",
        dividerClass: "border-black/20",
        hoverClass: "hover:bg-black/10",
    ...
    yellow: {
        tabClass: "bg-[var(--vr-palette-yellow)] shadow-[rgba(245,166,35,0.24)]",
        borderClass: "border-[rgba(245,166,35,0.70)]",
        ringClass: "ring-[rgba(245,166,35,0.22)]",
        softClass: "bg-[rgba(245,166,35,0.18)]",
