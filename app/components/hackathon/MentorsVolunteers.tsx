  ...
  const people = [
    {
      ...
      imageUrl: "/hackathon/photos/vladarozova.jpg",
    },
    {
      name: "Charles Rendigs",
      role: "Aus. Inst. of Energy - Director Nat. Board",
      imageUrl: "/hackathon/photos/charlesrendigs.jpg",
    },
    {
      name: "Dr. Nick Kirkwood",
      role: "University of Melbourne",
      imageUrl: "/hackathon/photos/nickkirckwood.jpg",
    },
    {
      name: "Dr. James Kahn",
      role: "Full-Stack ML engineer/researcher",
      imageUrl: "/hackathon/photos/jameskhan.png",
    },
    {
      name: "Govind Reghunandanan",
      role: "Machine Learning and AI Advisor",
      imageUrl: "/hackathon/photos/govind.png",
    },
    {
      name: "Annie Dang",
      role: " Full Stack Developer",
      imageUrl: "/hackathon/photos/anniedang.png",
    },
    {
      name: "Alexar Pendashteh",
      role: "Electron Workshop, President Linux VIC",
      imageUrl: "/hackathon/photos/alexar.png",
    },
    {
      name: "Oil Wongmayura",
      role: "Digital Event Manager",
      imageUrl: "/hackathon/photos/oil.png",
    },
    {
      name: "Michael Foley",
      role: "Data Scientist @ Solcast",
      imageUrl: "/hackathon/photos/michaelfoley.jpg",
    },
    {
      name: "Asmita Govind",
      role: "MetaPM",
      imageUrl: "/hackathon/photos/asmita.png",
    },
    /*
      ...
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-200">
            The MLAI Green Battery Hack would simply be impossible without our
