    ...
    <div className="relative sm:pt-24 bg-gray-900" style={{ height: "60vh" }}>
      <Container className="relative">
        <div className="relative isolate pt-14">
          <div
            className={`${styles.animatedBackground} absolute inset-x-0 top-0 sm:top-auto sm:-top-80 z-10 transform-gpu blur-3xl sm:h-auto`}
            ...
            <div className="mx-auto max-w-3xl pb-32 sm:pb-48 lg:pb-56">
              ...
              <div className="mt-16 space-y-6 text-center">
                <Lead className="text-black font-display tracking-tight">
                  The MLAI Green Battery Hack is a beginner friendly AI
                  hackathon to support Australia&apos;s journey to carbon net
                  zero. Your AI model will control a simulated battery trading
              ...
              <dl className="lg:grid mt-10 lg:grid-cols-3 gap-x-10 gap-y-6 sm:mt-16 sm:gap-x-16 sm:gap-y-10 sm:text-center lg:justify-start lg:text-left z-10">
                {[
                  ...
                  <div key={name}>
                    <dt className="font-mono text-sm text-teal-200 sm:text-black lg:text-black">
                      {name}
                    </dt>
