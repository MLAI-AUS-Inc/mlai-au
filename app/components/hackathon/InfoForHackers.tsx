...
export function InfoForHackers() {
  return (
    <section
      id="infoForHackers"
      aria-label="InfoForHackers"
      className="py-20 sm:py-48 bg-gray-900"
    >
      <div
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          ...
          <p className="mt-4 pb-10 font-display text-2xl tracking-tight text-gray-200">
            We&apos;ve jam packed the Green Battery Hack with everything you
            need to unleash your AI solution onto the Australian energy sector.
          </p>
        </div>
