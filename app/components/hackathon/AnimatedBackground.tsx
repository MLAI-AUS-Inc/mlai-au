...
const AnimatedBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!isClient || typeof window === "undefined" || !mountRef.current) return;
    ...
    // Lazy import Three.js modules only on client side
  ...
  }, [isClient]); // Include isClient in dependency array

  // Only render the div on client side to prevent hydration issues
  if (!isClient) {
