...
import { SubstackPost, getSubstackPosts } from '@/lib/getSubstackFeed'
import { Container } from '@/components/ui/Container'
import SubstackPostEmbed from '@/components/SubstackPostEmbed'
import SubstackSubscribe from '@/components/SubstackSubscribe'

export default function SubstackUpdates() {
  ...
  useEffect(() => {
    async function fetchPosts() {
      try {
        const fetchedPosts = await getSubstackPosts(3)
    ...
    return (
      <section className="bg-white py-24">
        <Container>
          ...
          <div className="mt-12 text-center text-gray-600">
            <p>Unable to load recent updates. Please visit our Substack directly.</p>
            <div className="mt-8">
              <SubstackSubscribe />
            </div>
          </div>
              ...
              {rest.map(post => (
                ...
                >
                  <div className="flex-auto">
                    <a href={post.link} className="font-semibold text-lg text-teal-500 hover:underline">
                      {post.title}
                    </a>
