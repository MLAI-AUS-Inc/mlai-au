        ...
        < div id='about' className="mx-auto my-24 max-w-7xl px-6 sm:my-32 lg:px-8" >
            <div className="mx-auto max-w-2xl lg:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                    Our vision is to make Australia an amazing home for AI and machine learning entrepreneurs and to increase the economic complexity of Australia. Let&apos;s get on it. <a href="#" className="font-semibold text-teal-500 hover:text-teal-500 transition duration-200 ease-in-out">Love letters: hi@mlai.au</a>
