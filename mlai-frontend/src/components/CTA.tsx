...
export default function CTA() {
    return (
        <div className="bg-black relative isolate px-6 py-24 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <a href="#" className="text-sm font-semibold leading-6 text-white hover:text-teal-400 transition duration-150">
