        ...
        < div className="mx-auto my-24 max-w-7xl px-6 sm:my-32 lg:px-" >
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our vision is to make Australia an amazing home for AI and machine learning entrepreneurs. Let&apos;s get on it. <a href="#" className="font-semibold text-teal-600">Love letters: hi@mlai.au</a>
            
            </p>

          <div className="flex justify-center items-center space-x-4 pt-6">
          <div class="flex items-center space-x-4 p-2 border border-gray-300 rounded-md">
            <a href="#" class="text-gray-600 hover:text-gray-500 transform hover:scale-105  transition duration-100 ease-in-out">
            ...
            <a href="#" class="text-gray-600 hover:text-gray-500 transform hover:scale-105  transition duration-100 ease-in-out"> 
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
