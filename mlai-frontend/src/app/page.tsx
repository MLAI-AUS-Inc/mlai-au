            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <a href="/contact" className="text-sm font-semibold leading-6 text-white hover:text-teal-300 transition duration-150">
        ...
        < div id='about' className="mx-auto my-24 max-w-7xl px-6 sm:my-32 lg:px-8" >
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our vision is to make Australia an amazing home for AI and machine learning entrepreneurs. Let&apos;s get on it. <a href="#" className="font-semibold text-teal-500 hover:text-teal-500 transition duration-200 ease-in-out">Love letters: hello@aihackmelb.com</a>
          ...
          <div className="flex items-center space-x-4 p-1 border border-gray-300 rounded-md">
            <a href="https://www.linkedin.com/company/mlai-aus-inc" target='_blank' className="text-gray-600 hover:text-teal-500 transform hover:scale-105  transition duration-100 pb-1 ease-in-out">
            ...
            <a href="https://join.slack.com/t/aihackmelb/shared_invite/zt-2br01q4n9-PiiT9mgEOPMEG__8SOWQ8g" target='_blank' className="text-gray-600 hover:text-teal-500 transform hover:scale-105  transition duration-100 ease-in-out"> 
