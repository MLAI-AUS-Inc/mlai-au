...
export default function SponsorsPage() {
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <div className="relative isolate bg-gray-900 pt-14 pb-24">
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              ...
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Showcase your brand to 1000+ AI professionals across our monthly meetups, 
                  hackathons, and online channels.
                </dd>
              </div>
              ...
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Be at the forefront of AI innovation by supporting the next generation 
                  of Australian AI startups and research.
                </dd>
              </div>
              ...
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Support ongoing community initiatives including monthly meetups, 
                  annual hackathons, and educational programs.
                </dd>
              </div>
            </dl>
          </div>
