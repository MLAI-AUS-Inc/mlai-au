...
export function Sponsors() {
  return (
    <section id="sponsors" aria-label="Sponsors" className="pt-72 pb-20 sm:pb-32 sm:pt-96 bg-gray-900">
      <Container>
        <h2 className="mx-auto max-w-2xl text-center font-display text-4xl font-medium tracking-tighter text-teal-500 sm:text-5xl">
          Current sponsors
        </h2>
