...
export function ExtendedInfo() {
  return (
    <section id="extendedinfo" aria-label="Schedule" className="py-20 sm:py-16 bg-white">
        <div
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          ...
          <p className="mt-4 pb-6 pt-6 font-display text-2xl tracking-tight text-teal-900">
          ...
          <p className="mt-4 pb-6 font-display text-2xl tracking-tight text-teal-900">
          ...
          <p className="mt-4 pb-0  font-display text-2xl tracking-tight text-teal-900">
