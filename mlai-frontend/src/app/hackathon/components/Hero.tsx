        ...
        <div className="relative sm:pt-24 bg-gray-900 min-h-screen">
            <Container className="relative">
                <div className="relative isolate pt-14">
                    <div
                        className={`${styles.animatedBackground} absolute inset-x-0 -top-40 z-10 transform-gpu blur-3xl sm:-top-80`}
                        aria-hidden="true"
                    >
                        <div
                            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80ffdd] to-[#89b9fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                            style={{
                                clipPath:
