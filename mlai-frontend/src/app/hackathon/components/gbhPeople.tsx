    ...
    <div className="bg-gray-900 pt-32  pb-24 md:pt-0">
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          <h2 className="font-display text-4xl font-medium tracking-tighter text-teal-200 sm:text-5xl">MLAI Aus team</h2>
          ...
          <a href="/" className="text-sm font-semibold leading-6 text-teal-300 hover:underline">
