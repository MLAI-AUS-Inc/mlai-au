...
import { ChevronLeftIcon, ChevronRightIcon, CalendarIcon, MapPinIcon, ClockIcon, XMarkIcon, CloudArrowDownIcon, ArrowTopRightOnSquareIcon } from '@heroicons/react/24/outline';
...
export default function LumaEventsPage() {
    ...
    const saveToNotion = async (events: LumaEvent[]) => {
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(`Failed to save to Notion (${response.status}): ${errorData}`);
            }
    ...
    // Initialize events from Notion - no mock data fallback
    useEffect(() => {
        const initializeEvents = async () => {
            try {
                ...
                // No fallback - keep events array empty
            } finally {
                setLoading(false);
            }
        };
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-white font-bold text-lg">
                                        {importSuccess ? '✅ Import Successful!' : 'Import Events from Luma'}
                                    </h3>
                ...
                <div className="relative mb-8">
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="relative">
                            {/* Event Image */}
                            <div className="relative h-96 bg-gradient-to-r from-purple-900 via-gray-900 to-teal-900">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold">{formatDate(events[currentIndex].startDate)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold">{formatTime(events[currentIndex].startDate)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="flex items-start justify-between mb-2">
                                    <h3 className="font-semibold text-gray-900 line-clamp-2 flex-1 pr-2">{event.name}</h3>
                                ...
                                <p className="text-sm text-gray-500 line-clamp-2">{event.location}</p>
                            </div>
                        </div>
                    ))}
                </div>
