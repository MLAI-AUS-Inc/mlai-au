...
import { a as getAuthorProfile } from "./authors-DzySQTZP.js";
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Most competitive federal grants (e.g. Industry Growth Program streams) have assessment cycles of 6–12 weeks after closing, with milestone-based payments once contracts are signed. Refundable tax offsets like the R&D Tax Incentive are claimed in the company tax return, so cash arrives after lodgement and ATO processing. Always check the current guidelines on business.gov.au for timing and evidence requirements."
  },
  {
    id: 3,
    question: "Are SAFE notes standard in Australia?",
    answer: "Yes. An Australian Law Firm (AUSSAFE) style note or the Y Combinator-style SAFE adapted for Australian law is common for pre-seed/seed. Most local angels and syndicates will use capped or uncapped SAFEs with MFN and pro-rata. Ensure the governing law, valuation cap, and discount are explicit, and get legal review before signing."
  },
  {
    id: 4,
    question: "Do I need ESIC status before talking to investors?",
    answer: "Early Stage Innovation Company (ESIC) eligibility is not mandatory, but it is attractive to Australian angels because it can provide tax offsets and CGT exemptions. If you think you qualify, prepare an ESIC self-assessment (or obtain an ATO ruling) so investors know where you stand."
  },
  {
    id: 5,
    question: "Can I raise from overseas investors while based in Australia?",
    answer: "Yes, but be clear on foreign investment rules (FIRB can apply for sensitive sectors), currency terms, and whether your constitution or shareholders agreement needs updates. Many Australian startups keep an Australian holding company and add a US Delaware subsidiary later if needed for specific funds."
  },
  {
    id: 6,
    question: "What documents do Australian investors expect in 2026?",
    answer: "Typical seed data rooms include: a concise deck (problem, solution, traction, market), a one-page financial model with runway/ask, cap table, constitution/shareholders agreement, IP assignments, privacy and AI-use statements (if applicable), and evidence of pilots or revenue. Keep them dated “as at <month/year>” and update after any material change."
  }
];
const summaryHighlights = {
  heading: `Key facts: ${TOPIC}`,
  intro: "Practical 2026 view for Australian founders: local grants first, transparent cap tables, ESIC where possible, and clear data governance for AI-enabled products.",
  items: [
    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-lg prose-indigo max-w-none text-gray-700", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          ...
          " – Australian venture funding tightened through 2024, but founders who paired early revenue with targeted grants and clean governance were still closing rounds in 8–14 weeks. This guide shows the 2026-ready pathways, documents, and milestones local investors and grant assessors actually expect."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArticleImageBlock, { src: HERO_IMAGE, alt: HERO_IMAGE_ALT }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Map your funding options in Australia (2026 overview)" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(QuoteBlock, { variant: "orange", title: "Start with the cheapest capital", icon: "💡", children: "Sequence matters: prove customer pull with grants and revenue first, then negotiate equity with better leverage and less dilution." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Validate the right capital type: grants, equity, debt, and revenue finance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-671ca2aa-27c3-437a-899f-dd4c881ec7d2.jpg?alt=media&token=4e75791c-075e-4aa5-a9e4-fbd3e2b1522f", alt: "Group of diverse entrepreneurs collaborate in a 90s-inspired tech startup environment, discussing funding options.", className: "w-full rounded-lg my-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Non-dilutive programs reduce risk and signal credibility. As at 2026, the Industry Growth Program and state-based innovation funds support MVP build and commercialisation for priority sectors. Angels and syndicates are best for speed and advice at pre-seed/seed; they usually want evidence of problem–solution fit and a clear plan to reach AU$1–3m ARR within 18–24 months. Venture debt and revenue-based finance become realistic once you have predictable monthly revenue and low churn." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Government and grant pathways (as at 2026)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Check business.gov.au for current guidelines. The R&D Tax Incentive remains the most accessible program for eligible R&D spend, but you must document hypotheses, experiments, and nexus to new knowledge. The Export Market Development Grant supports eligible overseas marketing, while state vouchers (e.g. LaunchVic, Advance Queensland) can offset pilot costs. Most programs require an ABN, compliant bookkeeping, and clear milestones." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Private capital: angels, syndicates, and VC" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Angels often move fastest and may offer smaller tickets (AU$25k–$250k) with industry expertise. Syndicates (e.g. community angel groups) pool tickets to meet a target round size. Seed VCs expect a validated wedge—repeatable sales motion, pilot-to-paid conversion, and a founder-friendly cap table. If using SAFEs, align on valuation cap, discount, and information rights, and keep a rolling cap table to avoid stacking too many notes." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Alternatives: loans and revenue-based finance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Venture debt and RBF providers usually look for 8–12 months of revenue history, gross margins that support repayments, and clear visibility on churn. Avoid taking debt for speculative R&D; use it to extend runway on proven revenue or to finance working capital. Always compare effective APR and covenant requirements to equity dilution." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Prepare investor-ready essentials (governance, ESIC, data)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-ecc283dd-8a63-4d9e-8c39-1b0d03eb7d66.jpg?alt=media&token=2fc2e7a0-9bcc-46cb-a48e-5c97b8f91cc0", alt: "Tech-savvy professionals in a vibrant 90s film aesthetic brainstorm for investor-ready essentials.", className: "w-full rounded-lg my-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Clean governance reduces friction. Maintain signed IP assignments, a clear constitution/shareholders agreement, and a single source of truth for your cap table. If you qualify for ESIC, document it—many Australian angels prefer ESIC-eligible companies for tax reasons. For AI-enabled products, include a short model-use statement covering data sources, evaluation, privacy, and human-in-the-loop controls aligned to OAIC privacy principles." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Where to meet investors and assess fit in 2026" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Prioritise warm introductions via customers, alumni, or founders in your sector. National programs (e.g. Startmate, Antler) and university accelerators still host demo days. Sector events—MedTech, ClimateTech, Cyber—attract specialist funds. Keep a shortlist by thesis, cheque size, and stage. Track interactions in a lightweight CRM and share monthly updates to build trust before you open the round." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "How much to raise and the milestones to anchor on" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Typical 2026 pre-seed rounds in Australia are AU$500k–$1.5m; seed ranges AU$1.5m–$4m. Set the amount based on 18 months of runway to reach the next evidence line—e.g. AU$50k+ MRR with sub-5% monthly churn, or 3–5 enterprise pilots converting to annual contracts. Anchor your ask on milestones, not just time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Due diligence and compliance: privacy, AI safety, and directors’ duties" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Investors will check corporate records, financial controls, tax compliance, privacy notices, data storage locations, and cyber practices. If you use AI models, explain data retention, fine-tuning datasets, and evaluation. Directors must meet duties under the Corporations Act; keep board minutes and related-party disclosures tidy. When in doubt, seek advice from an Australian lawyer or accountant familiar with startups." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AudienceGrid,
          {
