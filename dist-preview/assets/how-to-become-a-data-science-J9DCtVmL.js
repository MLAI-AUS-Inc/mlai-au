...
const faqItems = [
  ...
  },
  {
    ...
    answer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "A degree helps for competitive or research-heavy roles, but it is ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "not" }),
      " mandatory for many junior positions. Portfolios, internships, and evidence of real work often carry more weight. If you pursue study, compare Australian options (e.g., CS, stats, data science) against your goals and budget."
    ] })
  },
  {
    id: 3,
    question: "How long does it take to become job-ready?",
    answer: "Typical pathways: 6–12 months of focused self-study/bootcamp for career switchers; 2–4 years via a Bachelor; 1–2 years for a Master's. Timelines vary based on prior experience, time available, and the quality of your portfolio (as at 2026)."
  },
  {
    id: 4,
    question: "Which skills should I learn first?",
    answer: /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Python (pandas, NumPy, scikit-learn), SQL, exploratory data analysis, basic statistics (probability, sampling, testing), and data storytelling. Add cloud basics (AWS/GCP/Azure), version control (Git), and documentation." })
  },
  {
    id: 5,
    question: "Are data scientists in demand in Australia?",
    answer: "Demand varies by sector and state. Banking, health, government, energy, and consulting remain consistent employers. Check live job boards (e.g., Seek, LinkedIn) and industry salary guides for the latest signals (as at 2026)."
  },
  {
    id: 6,
    question: "How much can a data scientist earn in Australia?",
    answer: "Compensation varies by seniority, location, and sector. Consult current Australian salary guides (e.g., Hays, Michael Page) and live listings for up-to-date figures (as at 2026)."
  },
  {
    id: 7,
    question: "What's the difference between a data analyst and a data scientist?",
    answer: "Analysts focus on descriptive/diagnostic analytics (SQL, dashboards, reporting). Data scientists add predictive modelling, experimentation, and production considerations. Early-career roles often blend both."
  },
  {
    id: 8,
    question: "Can I switch from another field (e.g., biology, finance, marketing)?",
    answer: "Yes. Leverage your domain knowledge for projects (e.g., finance risk models, marketing uplift), then showcase results, assumptions, and limitations. Many Australian teams value domain-context plus core data skills."
  }
];
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-lg prose-indigo max-w-3xl px-4 py-10 sm:px-6 lg:px-8 text-gray-700 prose-headings:text-gray-900 hover:prose-a:text-[--brand-ink]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          ...
          " – If you typed “how to become a data science”, you almost certainly mean “data scientist”. In Australia (2026), hiring teams value clear, reproducible evidence of core skills over buzzwords. This guide maps a realistic, AU‑specific pathway, with links to official sources and practical next steps.",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/articles", className: "underline underline-offset-4", children: "Explore more in our Australian AI Ecosystem series" }),
          "."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArticleImageBlock,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArticleCallout,
          {
            ...
            children: "Save 10 current Australian job ads (Seek, LinkedIn, APSJobs). Tally recurring skills, tools, and responsibilities. Let that spreadsheet guide your learning plan and portfolio themes."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Do you need a degree? Australian pathways compared" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-1b88a997-ab31-4295-9567-3b03cd30ff60.jpg?alt=media&token=6107cbcc-471a-4835-9f46-d298a6e19b33", alt: "Group of diverse individuals collaborating in a tech startup, capturing a vibrant 90s film aesthetic.", className: "w-full rounded-lg my-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Degrees help for research‑heavy roles, but many junior hires come via portfolios, internships, and analyst roles. Compare effort, cost, and your timeline: a Bachelor/Master builds theory and signalling; bootcamps and micro‑credentials compress practice; self‑study can work if you ship quality projects and get feedback. As at 2026, employers still prioritise demonstrable skills and clear communication." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Degrees (Bachelor/Master)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pros: stronger theory, access to labs and internships, alumni networks. Cons: time and cost. If you choose this route, favour courses with applied units (SQL, Python, ML ops) and capstones with real data." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Bootcamps and micro‑credentials" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pros: focused practice and career support. Cons: outcomes vary—vet instructors and graduate portfolios. Look for structured interview prep, project feedback, and Australian employer connections." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Self‑study + project‑led learning" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Build a clear plan: Python/SQL fundamentals, 3–5 scoped projects on Australian open data, and weekly code reviews. Consider micro‑credentials to validate gaps (e.g., cloud or statistics). Your GitHub becomes your transcript." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArticleStepList,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(QuoteBlock, { title: "Hiring signal in 2026", variant: "purple", children: "“Hiring managers hire proof, not promise. A tiny, well‑explained project that solves a real problem beats a long list of ‘familiar with’ bullet points.”" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Core skills and tools employers list in 2026 job ads" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://firebasestorage.googleapis.com/v0/b/mlai-main-website.firebasestorage.app/o/content-factory%2FU05QPB483K9%2FMLAI-AUS-Inc%2Fmlai-au%2Fimages%2Finline-9820c594-854c-4167-aa7a-6cf7ba4caaec.jpg?alt=media&token=5c101b9e-8e5c-4038-a818-4946c3d10a4f", alt: "People collaborating in a vibrant tech startup, embodying 90s film aesthetics and modern creativity.", className: "w-full rounded-lg my-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Core: Python (pandas, NumPy, scikit‑learn), SQL, exploratory analysis, statistics (sampling, testing, bias), and data storytelling. Often requested: Jupyter, Git, cloud basics (AWS/GCP/Azure), dashboards (e.g., Plotly/Power BI), and ML practices (validation, leakage checks, feature importance). Alternatives appear too (R, PySpark, dbt) depending on stack." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "For production‑leaning roles, learn containerisation basics, simple APIs, and monitoring. For analyst‑leaning roles, strengthen SQL window functions, dimensional modelling, and communication." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AudienceGrid,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Get experience without experience: build and show your work" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Use Australian open data (e.g., ABS, data.gov.au, state portals) and frame problems as business questions: “Which customers are likely to churn?”, “Where should we target inspections?”. Keep scope tight (one dataset, one model, one decision), write a crisp README, and include limitations and next steps." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "What a strong portfolio looks like" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "- Reproducible: environment file, clear instructions, and seeded randomness.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "- Measured: baselines, validation, and error analysis (not just accuracy).",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "- Communicated: short executive summary plus notebook detail.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "- Ethical: documented data sources, privacy considerations, and bias checks."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Entry‑level titles and where to apply in Australia" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Look for titles like Junior Data Scientist, Data Analyst, BI Analyst, Graduate Data Scientist, or Junior ML Engineer. Search on Seek and LinkedIn; check APSJobs for government roles; scan graduate programs (banks, telcos, consulting); and explore university labs/centres for research assistant roles. Tailor applications to outcomes and link directly to relevant projects." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "How long does it take? Realistic timelines" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "As a guide (2026): 6–12 months of focused, project‑led learning can be enough for junior roles if you already have adjacent experience (e.g., software, analytics). A Bachelor typically takes 3–4 years; a Master’s 1–2 years. Progress is uneven—feedback loops and community support usually speed things up." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Ethics, privacy, and responsible AI in Australia" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "If you work with personal information, understand Australian privacy law (Privacy Act 1988 (Cth) and OAIC guidance). Document data sources, apply de‑identification where needed, and record assumptions and risks. As at 2026, broader AI policy settings continue to evolve—check official updates and your organisation’s governance requirements." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Choose a pathway and plug into community" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pick the route that fits your time and budget, then commit to a steady cadence: learn, build, review, apply. Community matters—study circles, code reviews, and meetups keep momentum and improve your work." }),
