...
const DEFAULT_AUTHOR_KEY = "samDonegan";
const DEFAULT_AUTHOR_AVATAR_FALLBACK_URL = "https://placehold.co/400x400/png";
function getAuthorProfile(key) {
  return authorRegistry[key];
}
function getDefaultArticleAuthorDetails() {
...
export {
  getAuthorProfile as a,
  getDefaultArticleAuthorDetails as g
};
