/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e309fcf6e353de6c3cce95fc3f8448cb)
// Runtime types generated with workerd@1.20260107.1 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_ADMIN_WORKSPACE_URL: string;
		VITE_GOOGLE_CLIENT_ID: string;
		VITE_DEV_AUTH_BYPASS: string;
		VITE_STUB_BACKEND: string;
		CF_LIVE_PREVIEW_DISABLE_HMR: string;
		PRIVATE_HUMANITIX_API_KEY: string;
		PUBLIC_HUMANITIX_API_KEY: string;
		LUMA_API_KEY: string;
		VIBE_RAISING_ADMIN_EMAILS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_ENABLE_FOUNDER_TOOLS_DISCOVER" | "WTH_ADMIN_URL" | "VALUE_FROM_CLOUDFLARE" | "BACKEND_BASE_URL" | "VITE_API_URL" | "VITE_SITE_URL" | "NEXT_PUBLIC_SITE_URL" | "VITE_ADMIN_WORKSPACE_URL" | "VITE_GOOGLE_CLIENT_ID" | "VITE_DEV_AUTH_BYPASS" | "VITE_STUB_BACKEND" | "CF_LIVE_PREVIEW_DISABLE_HMR" | "PRIVATE_HUMANITIX_API_KEY" | "PUBLIC_HUMANITIX_API_KEY" | "LUMA_API_KEY" | "VIBE_RAISING_ADMIN_EMAILS">> {}
}
